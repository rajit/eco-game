...
public class MonsterAI : Pathfinding2D 
{
    ...
    private void MoveAI()
    {
        ...
        {       
            ...
            string position = getVector(transform.position);
            float delta = Time.deltaTime;

            transform.position = Vector3.MoveTowards(transform.position, ignoreZ, delta * Speed);
        }
    }

    private string getVector (Vector3 position)
	{
